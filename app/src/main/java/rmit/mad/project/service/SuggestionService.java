...
public class SuggestionService extends IntentService {
    ...
    private TrackableService TrackableServiceInstance;
    ...
    protected void onHandleIntent(@Nullable Intent intent) {
        ...
        TrackableServiceInstance = TrackableService.getInstance();
        TrackableServiceInstance.init(getApplicationContext()); // In case no access to databse
